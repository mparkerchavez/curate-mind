...
export function ThemeCard({ theme, lastUpdatedDate, onOpen }: ThemeCardProps) {
  ...
  return (
    <button
      type="button"
      onClick={onOpen}
      className="group overflow-hidden rounded-2xl border border-secondary bg-primary text-left shadow-[0_1px_2px_rgba(16,24,40,0.04)] transition hover:-translate-y-0.5 hover:border-brand hover:shadow-[0_8px_24px_rgba(16,24,40,0.08)]"
    >
      ...
      <div className="border-t border-tertiary px-5 py-3">
